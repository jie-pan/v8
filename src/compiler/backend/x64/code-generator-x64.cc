...
// TODO(jie): Add Simd256 registers, and replace Simd128 registers with
// Simd256 registers.
...
#undef ATOMIC64_BINOP_CASE
    ...
    /*
    case kX64F32x4Div: {
      ASSEMBLE_SIMD256_BINOP(divps);
      break;
    }
    case kX64F32x8Eq: {
      ASSEMBLE_SIMD256_BINOP(cmpeqps);
      break;
    }
    case kX64F32x8Ne: {
      ASSEMBLE_SIMD256_BINOP(cmpneqps);
      break;
    }
    */
    case kX64F32x8Lt: {
    ...
    case kX64S256Select: {
      __ S256Select(i.OutputSimd128Register(), i.InputSimd128Register(0),
                    i.InputSimd128Register(1), i.InputSimd128Register(2),
                    kScratchDoubleReg);
      break;
    }
    ...
    default:
      std::cout << "codegen:unsupported opcode" << arch_opcode << std::endl;
      break;
  }
  return kSuccess;
    ...
    case MoveType::kRegisterToRegister:
      if (source->IsRegister()) {
        ...
        if (rep == MachineRepresentation::kSimd256) {
          CpuFeatureScope avx_scope(tasm(), AVX);
          __ vmovapd256(g.ToDoubleRegister(destination),
