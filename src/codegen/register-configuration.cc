...
RegisterConfiguration::RegisterConfiguration(
  ...
  if (fp_aliasing_kind_ == COMBINE) {
    ...
    num_float_registers_ = num_simd256_registers_ = num_simd128_registers_ =
        num_double_registers_;
    num_allocatable_float_registers_ = num_allocatable_simd256_registers_ =
        num_allocatable_simd128_registers_ = num_allocatable_double_registers_;
    for (int i = 0; i < num_allocatable_float_registers_; ++i) {
      allocatable_float_codes_[i] = allocatable_simd256_codes_[i] =
          allocatable_simd128_codes_[i] = allocatable_double_codes_[i];
    }
    allocatable_float_codes_mask_ = allocatable_simd256_codes_mask_ =
        allocatable_simd128_codes_mask_ = allocatable_double_codes_mask_;
  }
}
